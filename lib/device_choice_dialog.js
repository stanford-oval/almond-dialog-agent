...
const WHITELIST = [
    'google', 'twitter', 'sportradar', 'yahoofinance', 'weatherapi',
    'xkcd', 'nasa', 'ytranslate', 'uber', 'holidays', 'reddit_front_page',
    'thecatapi', 'giphy', 'gmail', 'imgflip', 'wall_street_journal',
    'washington_post', 'phdcomics', 'security-camera', 'bing',
    'facebook', 'thermostat', 'instagram', 'slack', 'linkedin'
];
...
module.exports = class DeviceChoiceDialog extends Dialog {
    ...
    static chooseDevice(parent, obj) {
        ...
        if (WHITELIST.indexOf(obj.kind) === -1) {
            obj.device = {
